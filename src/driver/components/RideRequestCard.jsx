...
export function RideRequestCard({
  ...
  return (
    <div
      className="card card-hover overflow-hidden animate-slide-in-right"
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="mt-4 grid grid-cols-3 gap-2">
          <Stat
            icon={Navigation}
            label="To pickup"
            value={`${request.distanceToPickupKm} km`}
          />

          <Stat
            icon={MapPin}
            label="Trip"
            value={`${request.tripDistanceKm} km`}
          />
