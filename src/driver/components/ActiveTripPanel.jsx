    ...
    <div className="card overflow-hidden animate-scale-in">
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="mt-4 flex items-center gap-2">
          <button className="btn btn-md tap bg-ink-100 text-ink-800 hover:bg-ink-200">
            <Phone size={16} />
          </button>
          ...
          <button
            onClick={onComplete}
            className="btn btn-md tap flex-1 bg-red-500 text-white hover:bg-red-600 shadow-glowRed font-bold"
          >
          ...
          <button
            onClick={onCancel}
            className="btn btn-md tap bg-ink-100 text-ink-700 hover:bg-ink-200 font-bold"
          >
            Cancel
          </button>
        </div>
