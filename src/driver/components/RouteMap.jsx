  ...
  return (
    <div className="relative w-full h-full overflow-hidden rounded-2xl bg-ink-900">
      ...
      >
        ...
        <path
          d="M0 220 Q 80 200 160 230 T 400 240 L400 300 L0 300 Z"
          fill="#18181b"
          opacity="0.7"
        />

        <path
          d="M280 0 Q 320 60 300 120 T 360 200 L400 200 L400 0 Z"
          fill="#18181b"
          opacity="0.5"
        />
        ...
        {status !== "idle" && (
          <>
            ...
            <g transform="translate(340 40)">
              <path
                d="M0 6 C -8 -6 -8 -14 0 -18 C 8 -14 8 -6 0 6 Z"
                fill="#eab308"
        ...
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-ink-950/80 backdrop-blur text-white text-xs font-semibold">
          <span
            className={`w-2 h-2 rounded-full ${
              online ? "bg-red-500 animate-ping-slow" : "bg-ink-400"
            }`}
          />
