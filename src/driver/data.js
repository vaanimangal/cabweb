...
export function makeRideRequest(seed) {
...
export const earningsHistory = Array.from({ length: 14 }, (_, i) => {
  const d = new Date(Date.now() - i * 86400000);
  const tripsThatDay = randInt(i + 40, 8, 16);

  return Array.from(
    { length: Math.min(tripsThatDay, 2) },
    (_, j) => {
      const seed = i * 100 + j;
...
export const reviews = [
  {
    ...
    rating: 5,
    comment:
      "Marcus was incredibly professional and got me to the airport on time. Very smooth ride!",
    date: "2025-07-04",
    tripRoute: "Mission District → SFO Terminal 2",
  },
  {
    id: "r2",
    ...
    rating: 5,
    comment:
      "Great conversation, clean car, and knew all the best routes around the city.",
    date: "2025-07-03",
    tripRoute: "Union Square → Fisherman's Wharf",
  },
  {
    id: "r3",
    ...
    rating: 4,
    comment:
      "Friendly driver, just a bit of a detour due to traffic. Otherwise excellent.",
    date: "2025-07-02",
    tripRoute: "Ferry Building → Golden Gate Park",
  },
  {
    id: "r4",
    passengerName: "Diego Romero",
    rating: 5,
    comment:
      "Best cab ride I've had in SF. Will definitely request Marcus again.",
    date: "2025-07-01",
    tripRoute: "Castro Theatre → Oracle Park",
  },
  {
    id: "r5",
    passengerName: "Emily Tran",
    rating: 5,
    comment:
      "Very safe driving, helped with luggage, and played great music. 10/10.",
    date: "2025-06-30",
    tripRoute: "SOMA → Coit Tower",
  },
  {
    id: "r6",
    ...
    rating: 4,
    comment:
      "Punctual and polite. Car was spotless. Would recommend.",
    date: "2025-06-29",
    tripRoute: "Nob Hill → Embarcadero",
  },
];
