        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-ink-500 mt-1">
              {verified} of {documents.length} documents verified. Keep
              documents current to stay eligible for rides.
            </p>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={() =>
                pushToast("info", "Document upload flow coming soon")
              }
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-3 flex items-center justify-between text-xs">
                    <div>
                      <p className="text-ink-400 font-semibold uppercase tracking-wide">
                        Expires
                      </p>
                      <p className="text-ink-800 font-bold mt-0.5">
                        {doc.expiryDate}
                      </p>
                    </div>
                    ...
                    <button
                      onClick={() =>
                        pushToast("info", `Re-upload for ${doc.name}`)
                      }
